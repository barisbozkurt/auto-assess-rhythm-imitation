...
data_arg.add_argument('--audio_path_trn_per', type=str, default='../../data/feat/train', help="audio directory path for student's train performances")
data_arg.add_argument('--audio_path_test_per', type=str, default='../../data/feat/test', help="audio directory path for student's test performances")
data_arg.add_argument('--audio_path_ref', type=str, default='../../data/feat/ref', help="audio directory path for references")
data_arg.add_argument('--model_save_path', type=str, default='../../data/models', help="model directory path for saving models")
data_arg.add_argument('--w_size', type=float, default=0.025, help="window size (in sec)")
...
data_arg.add_argument('--num_feat', type=int, default=20, help="dimension of the features")
data_arg.add_argument('--file_ext', type=str, default='_onset_CNN1D+LSTM.npy', help="extension for input files (Siamese network)")
