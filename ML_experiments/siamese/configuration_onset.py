...
data_arg.add_argument('--model_save_path', type=str, default='../../results/Siamese/models_onset', help="audio directory path for test")
data_arg.add_argument('--log_save_path', type=str, default='../../results/Siamese//logs_onset', help="audio directory path for test")
